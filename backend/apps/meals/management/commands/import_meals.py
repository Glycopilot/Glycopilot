        ...
        with open(path, 'r', encoding='utf-8') as f:
            ...
            for row in reader:
                try:
                    ...
                    self.stdout.write(self.style.ERROR(f"Error processing meal ID {row.get('id')}: {e}"))
            
            self.stdout.write(self.style.SUCCESS(f"Meals: {count_created} created, {count_updated} updated."))
